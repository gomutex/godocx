...
func TestCellBorders_MarshalXML(t *testing.T) {
	...
	borders := &CellBorders{
		...
		InsideH: &ctypes.Border{Val: stypes.BorderStyleSingle},
		InsideV: &ctypes.Border{Val: stypes.BorderStyleDouble},
		TL2BR:   &ctypes.Border{Val: stypes.BorderStyleThick},
		TR2BL:   &ctypes.Border{Val: stypes.BorderStyleThick},
	}
