...
type NumProp struct {
	...
	ILvl *ctypes.DecimalNum `xml:"ilvl,omitempty"`

	//Numbering Definition Instance Reference
	NumID *ctypes.DecimalNum `xml:"numId,omitempty"`

	//Previous Paragraph Numbering Properties
	NumChange *ctypes.TrackChangeNum `xml:"numberingChange,omitempty"`

	//Inserted Numbering Properties
	Ins *ctypes.TrackChange `xml:"ins,omitempty"`
}
