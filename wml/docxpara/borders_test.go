...
func TestParaBorder_MarshalXML(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "All fields set",
			input: ParaBorder{
				Top:     &ctypes.Border{Val: "single", Color: internal.ToPtr("auto")},
				Left:    &ctypes.Border{Val: "dashed", Color: internal.ToPtr("FF0000")},
				Right:   &ctypes.Border{Val: "double", Color: internal.ToPtr("00FF00")},
				Bottom:  &ctypes.Border{Val: "dotted", Color: internal.ToPtr("0000FF")},
				Between: &ctypes.Border{Val: "wave", Color: internal.ToPtr("123456")},
				Bar:     &ctypes.Border{Val: "thick", Color: internal.ToPtr("654321")},
			},
