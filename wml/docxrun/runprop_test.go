...
func TestRunProperty_MarshalXML(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: `<w:rPr><w:b></w:b><w:bCs></w:bCs><w:rtl></w:rtl><w:specVanish></w:specVanish><w:oMath></w:oMath><w:cs></w:cs><w:rStyle w:val="Heading1"></w:rStyle><w:i></w:i><w:iCs></w:iCs><w:strike></w:strike><w:dstrike></w:dstrike><w:outline></w:outline><w:shadow></w:shadow><w:caps></w:caps><w:smallCaps></w:smallCaps><w:emboss></w:emboss><w:snapToGrid></w:snapToGrid><w:imprint></w:imprint><w:vanish></w:vanish><w:webHidden></w:webHidden><w:noProof></w:noProof><w:spacing w:val="100"></w:spacing><w:kern w:val="20"></w:kern><w:position w:val="10"></w:position></w:rPr>`,
		},
		{
			name: "Only Bold set",
			prop: RunProperty{
